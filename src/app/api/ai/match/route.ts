...
// ВАЖНО: без «организ» и «под ключ» — это профессия «Организатор тоя» (один человек),
// а не команда. Иначе запрос «нужен организатор» ошибочно уходил в командный подбор.
const TEAM_SIGNALS = ["команд", "весь той", "полный праздник", "всё для", "все для", "собрать той", "собери той", "вся команда", "нужны все"];
